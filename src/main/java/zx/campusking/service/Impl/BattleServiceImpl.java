...
public class BattleServiceImpl implements BattleService {
    ...
    public BattleServiceImpl(CardCatalogService cardCatalogService, StatusEffectService statusEffectService) {
    ...
    public int computeAttack(PlayerState owner, CardInstance cardInstance) {
        ...
        return cardCatalogService.requireCard(definition.getId())
                .modifyAttack(owner, cardInstance, definition, baseHealth(definition, cardInstance), attack);
    }
    ...
    public void cleanupDefeated(MatchState match, PlayerState player, PlayerState rewardOwner, DeckService deckService) {
        ...
        for (CardInstance card : defeated) {
            ...
            if (cardCatalogService.requireCard(definition.getId())
                    .handleDefeated(match, player, card, definition)) {
                continue;
            }
    ...
    public CardDefinition cardDefinition(CardInstance instance) {
        return cardCatalogService.require(instance.getCardId());
    }
